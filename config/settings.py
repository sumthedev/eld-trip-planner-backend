...
# django-cors-headers — allow the Vite/CRA React dev server to call this API
...
# LocationIQ geocoding — free tier, no dev-IP bans (unlike Nominatim's public instance)
# Get a free key at https://locationiq.com/
# Reads from the .env file in the project root (same folder as manage.py)
